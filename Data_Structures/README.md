...
Each test case consists of two lines. The first line is a number n 1  
$\leq n \leq$  
1000 denoting the length of the given array. The second line consists of the elements of the array separated by space.  
